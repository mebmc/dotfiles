# Generated by Powerlevel10k configuration wizard on 2023-03-30 at 15:42 BST.
...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      '*work*'      WORK    # These values are examples that are unlikely
      '*personal*'  PERSONAL    # to match your needs. Customize them as needed.
      '*'           DEFAULT)
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND=208
  # typeset -g POWERLEVEL9K_AWS_DEFAULT_VISUAL_IDENTIFIER_EXPANSION='⭐'
  typeset -g POWERLEVEL9K_AWS_WORK_FOREGROUND=9
  typeset -g POWERLEVEL9K_AWS_PERSONAL_FOREGROUND=12
